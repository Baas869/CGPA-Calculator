...
function Course({ course, handleUnitChange, handleGradeChange, handleDeleteCourse, handleCourseTitleChange }) {
    return (
        <tr>
            {/* Course Title */}
            <td className='pr-3'><input className="course-title w-full uppercase" placeholder={"e.g EDU213"} value={course?.title} onChange={(e) => handleCourseTitleChange(e.target.value)}/></td>
            {/* Grade, dropdown */}
            <td className='pr-3'>
