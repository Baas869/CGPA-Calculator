...
function Offers() {
    ...
    return (
      ...
      <div className='content flex flex-col grow p-3 px-7 gap-1'>
        {/* Header */}
        <span className='content__header mb-2 border-b-4 border-[#00cc66] self-start pb-3'>GPA CALCULATOR</span>
        ...
        <div className='flex border-b-2  pb-3'>
          ...
          <div className='flex flex-col'>
            ...
            <button className='bg-[#00cc66] p-3 rounded text-white' onClick={handleViewAnalysis}>View Analysis</button>
          </div>
        </div>
        ...
        <div className='flex whitespace-nowrap flex-wrap'>
          ...
          <button className='ml-auto rounded border p-2 bg-[#00cc66] text-white' onClick={addSemester}>Add Semester + </button>
        </div>
        {/* Calculator */}
